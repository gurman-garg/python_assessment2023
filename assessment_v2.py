#Version 2: Improved Basic Cafe Click & Collect
...
#age function that asks user their age if they are not in student list, if age is not in range, asks again up to 3 times and if valueerror, asks again, and calls the ordering function
def Age():
    while True:
        try:
